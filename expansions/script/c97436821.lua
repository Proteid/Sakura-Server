...
function s.condition(e,tp,eg,ep,ev,re,r,rp)
	...
	return tc:IsFaceup() and tc:IsOriginalCodeRule(id)
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsCanBeSpecialSummoned(e,0,tp,false,false,POS_FACEUP) then
		...
		local g=mg:SelectSubGroup(tp,s.fselect,false,1,Ouroboros[c:GetControler()],tp,Ouroboros[c:GetControler()]*1000)
